		...
		<section className="bg-radial-gradient-1 text-white px-28 py-20 h-screen flex flex-row justify-between pr-44">
			<div>
				...
				<h4 className="text-2xl w-7/12 font-light font-sans">
					Hi, I’m Akash! A fullstack web developer and designer who is passionate about
					coding. I love creating websites for startups and companies to increase their
					exposure. Checkout my{" "}
					<a
